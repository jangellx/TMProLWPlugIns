...
#define LWVOLF_ADAPTIVE        (1<<0)    // pixel evaluation will use adaptive sampling
#define LWVOLF_SHADOWS        (1<<1)    // element will be evaluated for shadows
#define LWVOLF_REFLECTIONS    (1<<2)    // element will be evaluated for raytraced reflections
#define    LWVOLF_REFRACTIONS    (1<<3)    // element will be evaluated for raytraced refractions
