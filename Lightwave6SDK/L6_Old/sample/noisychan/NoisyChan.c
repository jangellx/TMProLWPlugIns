...
XCALL_(static LWError)NoisyChanCopy(NoisyData	*from, NoisyData	*to)
{
	XCALL_INIT;
...
XCALL_(LWError)NoisyChanSave(NoisyData *dat,const LWSaveState	*sState)
{
	float fv = 0.0f;
	XCALL_INIT;
	fv = (float)dat->offset;
