...
// ObtainMacs():
//  This is a modfied version of the code found at
//   http://www.cyberport.com/~tangent/programming/winsock/examples/getmac-snmp.html
//   where instead of streaming to the screen, the data 
//   is stored in a series of NetworkMACAddress instances.
void NetworkMAC::ObtainMACs() {
  HINSTANCE m_hInst;
...
*/
            ...
            // Joe's Code:  Store the MAC as NetworkMACAddress
            NetworkMACAddress *new_mac = new NetworkMACAddress( varBind[1].value.asnValue.address.stream );
